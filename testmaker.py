...
def main():
    ...
    parser.add_argument("-mc", action='store_true',
                        help="make multiple choice questions (like error detection)")
    ...
    mc_counter = 0
    mushra_counter = 0
    # make questions from all provided urls, for the question types specified in args
    for arg in sys.argv[1:]:
        for urls in url_dict[arg]:
            questions.append(make_question( qid=q_counter,
                                            urls=urls,
            ...
            mushra_counter += 1 if arg == '-mushra' and mushra_counter+1 < len(mushra_ref_urls) else 0
